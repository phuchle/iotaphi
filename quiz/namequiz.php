...
{ 
	...
	if(strstr($format,'A')!=false) $select .= '`user_snapchat` AS aim, ';
	$select = trim($select,", ");
...
?>
	...
	while($count-$curCount)
	{
		...
		echo '<a href="#" onclick="return overlib(\'',$name[name],'\', TEXTFONT, \'Tahoma\',FGBACKGROUND,\'http://puu.sh/glY1Q/c41b485ee6.png\', WIDTH,\'160\', CENTER , NOCLOSE, STICKY, TEXTCOLOR, \'#81D8DO\', TEXTSIZE,\'3\');" onmouseout="return nd();"><img class=\"profile" src="/images/profiles/', $ids[$num[$curCount]], '.jpg" title="', $sn[aim] ,'" border=0 width=160></a>';
