...
//does not work atm
function stats_fellowship_byclass() {
	$term = db_currentClass('start');
	$service = EVENTTYPE_FELLOWSHIP;
	...
	$sql = 'SELECT class_nick, '
			...
			. " AND event_date > '$term' AND eventtype_id = 2 "
			. ' GROUP BY class.class_id ORDER BY events desc LIMIT 10';
