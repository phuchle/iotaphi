...
<div  class="row-fluid">
	<div class="span12 calborder" id="calendar-controls">

	<div class="span3 event-filter">
		<select name="filters" onchange="fill()" class="span8 ">
			...
			<option value="13" <?php echo ($filter==13)?'selected':'' ?>>Outreach</option>
		</select>
	</div>
...
<div class="span3 visible-desktop">
	<form  class="form-inline " action="http://www.iotaphi.org/calendar.php" name="quickJump">
				<select name="month" id="monthDropDown" class="span4 offset1 " ></select>
				<select name="year" id="yearDropDown" class="span4"></select>
				<input class="btn span3"  type="submit" value="Go" onClick="http://www.iotaphi.org.org/calendar.php">
	</form>
	</div>
	</div>
	</div>
...
$GMToffset = 28800; // 8 Hours - Stanton Ho 2/25/16
...
for($i=0,$k=0; $i<$weeks; $i++) // One row for each week
{
 ...
 $extraHour = date("I", $today12AM)*60*60; // daylight saving hour
  if ( strtotime( "now" )-$today12AM-$GMToffset > 25200+$extraHour && strtotime( "now" )-$today12AM-$GMToffset < 111600+$extraHour )
  {
//      echo strtotime("now");
//      echo "\n";
//      echo strtotime("now")-$today12AM-$GMToffset;
//      echo "\n";
//      echo $today12AM;
      //echo $today12AM;
   $style = "calToday";
