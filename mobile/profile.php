...
$sql = 'SELECT user_name, family_name, class_nick, user_address, '
        . ' user_phone, user_cell, user_email, user_snapchat, user_password '
...
<tr class="black">
		<td>Snapchat: </td>
		<td><img src="http://www.iotaphi.org/images/smallsnapchat.jpg" <?php echo htmlentities($user_snapchat) ?> /><?php echo htmlentities($user_snapchat) ?></a></td>
	</tr>
	<tr>
		<td>Family: </td>
