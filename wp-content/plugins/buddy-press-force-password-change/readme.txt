...
Tags: buddypress, password, force password change
...
Force Buddypress users to change their password on their next login.
...
== Installation ==
1. Upload **bp-force-password-change** folder to the **/wp-content/plugins/** directory
...
== Screenshots ==
1. change password modal window
2. force password change checkbox
