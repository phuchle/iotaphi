...
$LastChangedDate: 2011-12-02 18:48:17 -0700 (Fri, 02 Dec 2011) $
$Rev: 7403 $
*/
...
function sfa_admin_load_js()
{
	...
	if($SFSTATUS == 'ok')
	{
		...
		wp_enqueue_script('sfjs', SFJSCRIPT.'install/sfa-install.js', array('jquery', 'jquery-ui-core', 'jquery-ui-widget', 'jquery-ui-progressbar'), false, false);
	}
	return;
}
