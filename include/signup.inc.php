...
function signup_mailAffected($shift, $before_user, $after_user)
{
    ...
    $message = "A signup replacement took place on the Iota Phi website and you were affected!\n\n"
             . "Project: $name\n"
             . "Date and Time: $date at $time\n\n"
             . "$before_name has been replaced with $after_name.\n\n"
             . "If this is a mistake, please email admin@iotaphi.org.\n\n"
             . "Thank you!\nThe Website";

	mail("$after_name <$after_email>, $before_name <$before_email>", 
         "Service Project Replacement: $name",
         $message,
         "From: Iota Phi Webmasters <admin@iotaphi.org>");
    
    // send email to SVP's notifying them of replacement
    $message = "A signup replacement took place on the Iota Phi website!\n\n"
             . "Project: $name\n"
             . "Date and Time: $date at $time\n\n"
             . "$before_name has been replaced with $after_name.\n\n"
             . "Keep up the good work, Service VP's! =)\nIota Phi Website";
    mail("<service@iotaphi.org>", 
    "Service Project Replacement: $name",
    $message,
    "From: Iota Phi Website <admin@iotaphi.org>");
