...
$sql = "SELECT user_id as id FROM user WHERE user_snapchat = '$sn' ";
...
function userfull_get($search)
{
	...
	. ' user_email, user_snapchat, family_name, user_id, SUBSTRING_INDEX(class_name, \' \', -1) AS class_name '
...
foreach($results as $user)
{
	...
	$user_snapchat = "<a href=\"aim:goim?screenname=$user_snapchat\">$user_snapchat</a>";
	...
	echo "Screen Name: $user_snapchat<br>";
