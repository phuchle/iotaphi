...
if ( isset( $_POST['first'] ) && isset( $_POST['last'] ) && isset( $_POST['email'] ) && isset( $_POST['phone'] ) && isset( $_POST['chapter'] ) )
{
	...
	if ( $error != true )
	{
		...
		if ( $result['id'] )
		{
			...
			$register = true;
			$headers = 'From: no-reply@iotaphi.org';
...
<?} ?>
	<div id="home">
		...
		<p>We are very excited to reunite with our fellow IC Brothers and create new friendships!  We also encourage and invite all of our IC brothers to stay Saturday night with us to continue the fellowship festivities!  If you have any questions, or have chosen your theme choices, please contact us at fallfellowship@iotaphi.org.  Thank you!</p>
	</div>
	<div id="agenda">
	...
	<div id="footer">
		<span class="subtext">hosted by Iota Phi chapter at UC Davis</span>
	</div>
	</div>
	<?php
	if ( $error==true ) {?>
