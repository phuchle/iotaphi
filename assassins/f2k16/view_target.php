...
{
  $sql = "SELECT * FROM `assassinsf2k16` WHERE `num_kills` = 0 AND `alive` = 1 OR `num_kills` = 1 AND `alive` = 1"; 
...
<big> <center> <a href = "killed_zero_kills.php"> Click Here If You Killed Someone With Less Than <font color = 'red'> Two </font> Kills</a> </big>
<br>
<br>
<br>
