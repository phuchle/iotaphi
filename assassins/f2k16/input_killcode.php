...
function update_total_kills($tempID, $killcount)
{
	...
	$result3 = mysql_query($sql3) or die("wtf Query Failed (get_player_info)! ". mysql_error());
...
function update_death_time($target, $time1)
{
	...
	$sql7 = "UPDATE `assassinsf2k16` SET `death_time` = '$time1' WHERE `assassinsf2k16`.`user_id` = $target;";
...
{
	header("Location:/assassins/f2k16/liar_killcode.php");
	exit(1);
}
