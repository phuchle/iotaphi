...
if($myInfo['alive']==0)
{
  header("Location:/assassins/2k16/am_dead.php");
  exit(1);
...
{
  $sql = "SELECT * FROM `assassins2k16` WHERE `alive` = 1 AND `num_kills` = 0"; 
...
<center>
<br> 
<a href = "confirm_kill.php"> Click Here If You Killed Your MAIN Target: <?php echo $myTargetInfo['codename'];?> </a>
<br> 
<br>
<br>
<br>
<br>
<center><b> <font size = '4'> You Can Now Kill Anyone of These Assassins With ZERO Kills: </b></center></font>
<br>
<br>
<?php 
...
<big> <a href = "killed_zero_kills.php"> Click Here If You Killed Someone With <font color = 'red'> Zero </font> Kills</a> </big>
<br>
<br>
<br>
