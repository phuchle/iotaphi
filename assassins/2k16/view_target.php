...
if($myInfo['alive']==0)
{
  ...
  ?> <center>SINCE WE FEEL BAD FOR YOU, YOU CAN NOW KILL SOME ONE. <br> You still kinda suck though...</center>
...
{
  $sql = "SELECT * FROM `assassins2k16` WHERE `num_kills` = 1 AND `alive` = 1 OR `num_kills` = 0 AND `alive` = 1"; 
