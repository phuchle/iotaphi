...
include dirname(dirname(__FILE__)) . '/include/database.inc.php';
include dirname(dirname(__FILE__)) . '/tools/jpgraph/src/jpgraph.php';
include dirname(dirname(__FILE__)) . '/tools/jpgraph/src/jpgraph_bar.php';
